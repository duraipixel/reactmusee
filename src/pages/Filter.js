...
export const Filter = ({filterStaticMenu}) => {
    ...
    return (
        <Fragment >
            <div className="col-lg-3 col-md-3 col-sm-3 col-xs-12 sdmnu-repnsve mCustomScrollbar">
                <div className="filter-lists">
                    <h3>Filters</h3>
                    <div className={`clear_filter ${Array.from(CommonUrl.searchParams).length > 0 ? '':'hide'}`} onClick={() => clearFilter()}> Clear Filter </div>
