...
export const PrivacyPolicy = () => {
  return (
    <div>
      <Helmet>
        <title>Privacy Policy - Musee Musical</title>
        <link rel="canonical" href={window.location.href} />
        <meta name="description" content="Our privacy policy ensures the protection of your personal information. Discover how we prioritize your data security today." />
        <meta
        ...
        <div className="container">
          <div className="row">
            <div className="contents-sector">
              <p>
                Musee Musical respects the privacy of it’s users and is
                committed to protect it in all respects. This{" "}
                <b>Privacy Policy</b> provides succinctly the manner your data
                is collected and used by Musee Musical. You are advised to
                please read the Privacy Policy carefully. By accessing the
                services provided by Musee Musical you agree to the collection
                and use of your data by Musee Musical in the manner provided in
                this Privacy Policy.
              </p>
              ...
              <p>
                You may wish to terminate your account at any time. However,
                your information may remain stored in archive on our servers
                even after the deletion or the termination of your account.
              </p>
              ...
              <ul>
                ...
                <li>
                  {" "}
                  To preserve social history as governed by existing law or
                  policy
                </li>
              </ul>
              <br />
              ...
              <ul>
                <li>
                  {" "}
                  remind us of who you are in order to deliver to you a better
                  and more personalized service from both an advertising and an
                ...
                <li>
                  ...
                  and to track entries, submissions, and status in prize
                  drawings
                </li>
              ...
              <ul>
                ...
                <li>
                  ...
                  and illegal activities, suspected fraud, potential threat to
                  the safety or security of any person, violations of Musee
                  Musical’s terms of use or to defend against legal claims
                </li>
                <li>
                  {" "}
              ...
              <p>
                ...
                Musee Musical reserves the right to send you certain service
                related communication, considered to be a part of your Musee
                Musical account without offering you the facility to opt-out.
              ...
              <p>
                ...
                archive on our servers even after the deletion or the
                termination of your account.
              </p>
              <p>
                If we plan to use your personally identifiable information for
                any commercial purposes, we will notify you at the time we
                collect that information and allow you to opt-out of having your
                information used for those purposes.
              </p>
              <h4>
                What security procedures are in place to protect information
              ...
              <p>
                ...
                servers are accessible only to authorized personnel and that
                your information is shared with respective personnel on need to
                know basis to complete the transaction and to provide the
                services requested by you.
              </p>
              <p>
                Although we will endeavor to safeguard the confidentiality of
              ...
              <p>
                Please email{" "}
                <b>
                  <a href="mailto:info@museemusical" target="_blank">
