        ...
        <>
          <Helmet>
            ...
            {productInfo.meta && productInfo.meta.meta_description && (
              <meta
                name="description"
                content={productInfo.meta.meta_description}
              />
            )}
            <meta
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="accordion-table text-left pb-4">
                    <ul>
                      {productInfo.parent_category_name && (
                ...
                <div className="col-lg-6">
                  <ImagePane
                    ...
                    hideMagnify={hideMagnify}
                  />
                </div>
                <div className="col-lg-6">
                  <div className="small mb-1">SKU: {productInfo.sku}</div>
                  <h1 className="fw-bolder text-secondary h3">
                    {productInfo.product_name}
                  </h1>
                  <div className="fs-5 mb-3 text-dark">
                    {productInfo.sale_prices.strike_rate_original > 0 && (
                  ...
                  <div className="d-flex align-items-center mb-3">
                    ...
                    >
                      ...
                      <InputNumber
                        className={"custom-input-number fw-bold"}
                        value={productSelectedQuantity}
                      />
                  ...
                  {productInfo.stock_status.includes("in_stock") ? (
                    ...
                    <Chip
                      label={productInfo.stock_status.replace("_", " ")}
                      size="large"
                      className="rounded p-3 py-4 text-uppercase mt-4 product-chip"
                      color="error"
                    />
                  )}
                  {productInfo?.feature_information && (
                    <div className="abt-prduct">
                      ...
                      <div
                        dangerouslySetInnerHTML={{
                          __html: productInfo.feature_information,
                        }}
                      ></div>
                    </div>
                  )}
