...
const Cart = () => {
  ...
  const [flatCharge, setFlatCharge] = useState(
    localStorage.getItem("flat_charge") || ""
  );
    ...
    axios({
      ...
      .then((res) => {
        ...
        localStorage.setItem(
          "shiprocket_charges",
          JSON.stringify(res.data.shiprocket_charges)
        );
    ...
    axios({
      ...
      .then((res) => {
        ...
        if (res.data.error == 1) {
          ...
          localStorage.setItem(
            "address",
            JSON.stringify(res.data.customer_address)
          );

          let defaultShip = res.data.customer_address.find(
                  ...
                  <div className="col-lg-8">
                    <div className="finalcart-list">
                      <ProductDetails
                        ...
                        getShippingRocketCharges={getShippingRocketCharges}
                      ...
                      <div className="shipping-addresss">
                        <ShippingAddress
                          ...
                          handleSetBillingAddress={handleSetBillingAddress}
              ...
              <div id="cart-loader">
                <div className="loader-wrapper">
                  ...
                  <div className="loader-text">
                    <i class="bi bi-exclamation-circle me-2"></i> Payment
                    Processing, Don't try to go back or refresh{" "}
                  </div>
                </div>
              </div>
            )}
