...
export const FilterPane = (props) => {
  ...
  const products =
    filterData?.products != undefined ? filterData?.products?.products : [];
    ...
    <Fragment>
      ...
      <div className="my-4">
        <div className={`text-center `}>
          {filterData?.products?.total_count == 0 &&
          filterData?.products?.to >= filterData?.products?.total_count ? null : (
          ...
          <Button
            ...
            className="m-md-2 m-4 float-md-end"
          >
