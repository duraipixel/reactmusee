...
export const FilterItems = () => {
  ...
  const products =
    filterData?.products && filterData?.products != "undefined"
              ...
              <Link to={`/product/${item.product_url}`}>
                <div className="prdt-img">
                  ...
                  <div
                    className={`ofr-prc ${
                      item.sale_prices &&
                      item.sale_prices.overall_discount_percentage > 0
                        ? ""
                        : "hide"
                    }`}
                  >
                    <h5>
                      {item.sale_prices.overall_discount_percentage}
                      <span>Off</span>
                    </h5>
                  </div>
                </div>
                <div className="ratings d-flex justify-content-between">
                  <div className="prdt-type">{item.category_name}</div>
                  {/* <div
                ...
                <div className="prdt-nameprc">
                  ...
                  <h5>
                    {item.sale_prices.strike_rate &&
                      item.sale_prices.strike_rate_original > 0 && (
                        <span>₹{item.sale_prices.strike_rate}</span>
                      )}
